	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<div class="container">
					<%-- <form method="get" name="categoryForm"
								...
								<c:forEach items="${li}" var="list">
									<a href="#" class="list-group-item">
										<div class="media col-md-3">
											<figure class="pull-left">
												<img class="media-object img-rounded img-responsive"
													src="./img/list/${list.filename}" alt="">
											</figure>
										</div>
										...
										<div class="col-md-6">
											...
											<p class="list-group-item-text">${list.price }</p>
										</div>

										<div class="col-md-3 text-center">
											<button type="button"
												class="btn btn-primary btn-lg btn-block">구매하기</button>
										</div>
									</a>
								</c:forEach>
