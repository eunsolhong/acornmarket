								...
								<form method="post" enctype="multipart/form-data"
									...
									<div class="form-group">
										<input type="hidden" name="readcount"
											value="${article.readcount}"> <input type="hidden"
											name="userid" value="22"> <input type="text"
									...
									<tr>
										...
										<label><input type="text" size="30" class="form-control" style=" margin-top: 3px;"id="address2" name="address2" placeholder="상세주소"> </label>		
