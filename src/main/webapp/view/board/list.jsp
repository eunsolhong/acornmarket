				...
				<div id="demo" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="${pageContext.request.contextPath}/img/list/purple.png" alt="purple" width="800" height="300">
							<div class="carousel-caption"></div>
						</div>
						<div class="carousel-item">
							<img src="${pageContext.request.contextPath}/img/list/event.png" alt="event" width="800" height="300">
							<div class="carousel-caption"></div>
						</div>
						<div class="carousel-item">
							<img src="${pageContext.request.contextPath}/img/list/ebichu.png" alt="ebichu" width="800" height="300">
							<div class="carousel-caption"></div>
						</div>
					</div>
						...
						<div class="product-grid8">
							<div class="product-image8">
								<a href="#"> <img class="pic-1" src="./img/list/airpods.JPG">
									<img class="pic-2" src="./img/list/${article.filename}">
								</a>
								<ul class="social">
									<li><a href="" class="fa fa-heart"
										style="text-decoration: none"></a></li>
							...
							<div class="product-content">
								<div class="price">${article.subject}</div>
								<span class="product-shipping">${article.price}</span>
							</div>
						</div>
					</div>
