				...
				<div id="demo" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="purple.png" alt="purple" width="800" height="300">
							<div class="carousel-caption"></div>
						</div>
						<div class="carousel-item">
							<img src="event.png" alt="event" width="800" height="300">
							<div class="carousel-caption"></div>
						</div>
						<div class="carousel-item">
							<img src="ebichu.png" alt="ebichu" width="800" height="300">
							<div class="carousel-caption"></div>
						</div>
					</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="product-grid8">
							<div class="product-image8">
								<a href="#"> 
								<img class="pic-1" src="./img/list/${li.filename}"> 
								<img class="pic-2" src="./img/list/${li.filename}">
								</a>
								<ul class="social">
